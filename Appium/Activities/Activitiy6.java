...
public class Activitiy6 {
	...
	public void volume75Test() {
		...
		Point start = new Point((int) (dims.getWidth() * .50), (int) (dims.getHeight() * .74));
		Point end = new Point((int) (dims.getWidth() * .67), (int) (dims.getHeight() * .74));
		// Perform swipe
	...
	public void volume25Test() {
		...
		// Set the start and end points
		Point start = new Point((int) (dims.getWidth() * .50), (int) (dims.getHeight() * .74));
		Point end = new Point((int) (dims.getWidth() * .34), (int) (dims.getHeight() * .74));
		// Perform swipe
		ActionsBase.doSwipe(driver, start, end, 2000);
