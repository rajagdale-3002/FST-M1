...
public class Activity8 {
	...
	public static void main(String[] args) {
       ...
       // builder.click(cargoLock).pause(1000).moveToElement(cargoToml).pause(5000).click(cargoToml).build().perform();
         builder.click(buttons.get(0)).pause(1000).moveToElement(buttons.get(1)).pause(5000).click(buttons.get(1)).build().perform();
        ...
        builder.doubleClick(buttons.get(2)).pause(3000).pause(5000)
        .contextClick(buttons.get(3)).pause(3000).build().perform();
        // and then open it
        builder.click(driver.findElement(By.xpath("//span[text()='Open']"))).pause(5000).build().perform();
        // Print the front side text
